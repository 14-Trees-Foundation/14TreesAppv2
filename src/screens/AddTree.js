...
const AddTreeScreen = ({ navigation, route }) => {
  ...
  async function addDetails(tree, images) {   
  ...
  return <TreeForm treeData={inputTreeData} updateUserId={true} updateLocation={true} onVerifiedSave={addDetails} mode={treeFormModes.addTree} />;
}
